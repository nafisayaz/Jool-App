		...
		<nav class="navbar navbar-default navbar-fixed-top" >
			<div class="container-fluid header-border"  style=" padding-left: 0;padding-right: 0">
				<div class="container" style=" margin-top: 2em;padding-left: 0;padding-right: 0">
					<div class="col-md-3" >
						<img src="../images/Jool-logo.jpg" class="img-responsive" style="width: 40px;">
					</div>
		...
		<div class="carousel media-carousel" data-ride="carousel" id="media">
			<div class="carousel-inner">
				<div class="item active">
					<img src="../images/bg1.jpg" class="img-responsive animated zoomInLeft">
				...
				<div class="item ">
					<img src="../images/bg_lp11.jpg" class="img-responsive animated zoomInRight">
					<div class="carousel-caption">
				...
				<div class="item ">
					<img src="../images/bg_lp13.png" class="img-responsive animated zoomInRight">
					<div class="carousel-caption">
	...
	<div id="team" class="team">
		<div class="container">
			<div class="row">
				...
				<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
				<div class="col-lg-3 col-md-3">
					<img src="../images/img2.jpg"  class="img-circle" alt="">
					<h4>John Doe</h4>
					<b>CEO and Founder</b>
					<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
